...
export const QrCode = async () => {
    ...
    return (
      <section className="text-myGray">
        <ApiTitle text="QR Code" />
        <p className="mt-5">
          The library exports three QRCode helpers. Lets start with a NextJS
          example. You can import <PastableSpan text="QRCodeDisplay" /> from
        ...
        <BlockWrapper code={nextJSCodeExample} />
        <div className="mt-5">
          Now if you use vanilla react i.e create-react-app or vite maybe you can
          import <PastableSpan text="QRCodeDisplayReact" /> from react but you
        ...
        <BlockWrapper code={backendQRCode} />
        <p className="mt-5">
          After fetching your QRCode in your backend you can then use the{" "}
          <PastableSpan text="QRCodeDisplayReact" /> from{" "}
          <PastableSpan text="daraja-kit" /> to display your QRCode . Example
        </p>
        <BlockWrapper code={frontendVanillaReactCode} />
        <p className="mt-5">
          You can use the <PastableSpan text="className" /> prop to adjust the
